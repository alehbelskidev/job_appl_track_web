import { type RegisterSchema, registerSchema, authResponseSchema } from "@/schemas"
...
const useRegisterMutation = () => {
	...
	return useMutation({
		mutationKey: ['login'],
		mutationFn: (data: RegisterSchema) => api.post('/auth/register', data, authResponseSchema),
		onError: (err) => {
